...
def cart_pole_2():
    ...
    for episode in range(300):
        ...
        while True:  # 训练没有结束的时候循环
            ...
            print('x %d, x_dot %d, theta %d, theat_dot %d, reward %d, done %s' %
                  (x, x_dot, theta, theat_dot, reward, done))
            ...
            reward = reward1 + reward2                                          # 将奖励综合
            print('reward1 %d, reward2 %d, reward3 %d' % (reward1, reward2, reward))
